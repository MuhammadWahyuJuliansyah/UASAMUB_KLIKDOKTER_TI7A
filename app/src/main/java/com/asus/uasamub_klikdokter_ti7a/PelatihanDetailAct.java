    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                guru_spot_pelatihan.setText(dataSnapshot.child("dokter").getValue().toString());
                konsul_pelatihan.setText(dataSnapshot.child("konsul").getValue().toString());
                sertifikat_pelatihan.setText(dataSnapshot.child("jumlah_dokter").getValue().toString());
