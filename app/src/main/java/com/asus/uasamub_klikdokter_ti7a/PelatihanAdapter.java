...
public class PelatihanAdapter extends RecyclerView.Adapter<PelatihanAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder myViewHolder, int i) {
        ...
        myViewHolder.xnama_pelatihan.setText(myPelatihan.get(i).getNama_dokter());
        myViewHolder.xlokasi.setText(myPelatihan.get(i).getLokasi());
        myViewHolder.xjumlah_pelatihan.setText(myPelatihan.get(i).getJumlah_pembelian() + " Konsul");

        final String getNamaPelatihan = myPelatihan.get(i).getNama_dokter();
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            xjumlah_pelatihan = itemView.findViewById(R.id.xjumlah_kelas);
